...
admin.site.site_header = "mfeed"
admin.site.site_title = "mfeed Admin Portal"
admin.site.index_title = "mfeed Admin"

# swagger
api_info = openapi.Info(
    title="mfeed API",
    default_version="v1",
    description="API documentation for mfeed App",
)
